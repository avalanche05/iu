...
from app.api.routes import application, candidate, folder, resume, user, vacancy, generate, interview, competence
...
api_router.include_router(competence.router, prefix="/competencies", tags=["competence"])
