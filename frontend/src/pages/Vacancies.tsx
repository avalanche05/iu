...
import CreateVacancyFromPdfButton from '@/components/CreateVacancyFromPdfButton';
                                ...
                                <div className='grid gap-4 py-4'>
                                            ...
                                            <SelectContent>
                                                {Object.keys(GradeLabels).map((key) => (
                                                    <SelectItem key={key} value={key}>
                                                        {
                                                            GradeLabels[
                                                                key as keyof typeof GradeLabels
                                                            ]
                                                        }
                                                    </SelectItem>
                                                ))}
                                    ...
                                    <div>
                                        ...
                                        <MultipleSelector
                                            ...
                                            defaultOptions={[
                                                ...new Set(rootStore.competencies),
                                            ]?.map((competency) => ({
                                                label: competency,
                                                value: competency,
                                            }))}
